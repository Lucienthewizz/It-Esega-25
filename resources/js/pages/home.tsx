                            ...
                            <div className="text-center md:text-left" data-aos="fade-up">
                                ...
                                <div className="flex justify-center space-x-4 md:justify-start">
                                    ...
                                    <button
                                        ...
                                        className="group relative inline-flex items-center overflow-hidden rounded-lg border border-red-200 px-5 py-3 text-base font-medium text-red-600 transition-all duration-300 after:absolute after:inset-0 after:rounded-lg after:bg-red-50/0 after:transition-colors after:duration-300 hover:border-red-300 hover:text-red-700 hover:shadow-md hover:after:bg-red-50/80 sm:px-6 sm:py-4 sm:text-lg"
                                    >
                                        <span className="relative z-10 flex items-center">
                                            <span className="mr-2">How to Register</span>
                                            <div className="relative h-6 w-6">
                                                <div className="absolute inset-0 rounded-full bg-red-100 transition-opacity duration-300 group-hover:bg-red-200"></div>
                                                <svg
                                                    className="relative h-6 w-6 text-red-600 transition-colors duration-300 group-hover:text-red-700"
                                                    fill="currentColor"
                                                    viewBox="0 0 24 24"
                                                >
                    ...
                    <section className="relative overflow-hidden py-16 md:py-24">
                        ...
                        <div className="relative z-10 mx-auto max-w-[1350px] px-4 md:px-8 lg:px-12">
                            ...
                            <div className="mx-auto max-w-4xl px-4 sm:px-0">
                                <div
                                    className="relative w-full overflow-hidden rounded-2xl border-4 border-red-500/20 shadow-2xl transition-all duration-500 hover:border-red-500/40"
                                    data-aos="fade-up"
                                    data-aos-delay="150"
                                >
