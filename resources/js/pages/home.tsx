                        ...
                        <div className="container mx-auto px-6">
                            <div className="grid grid-cols-1 gap-8 md:grid-cols-[2fr_1fr_1fr]">
                                ...
                                <div className="text-white">
                                    <img src="/images/LogoEsega25.png" alt="BUILD-IT 2024" className="mb-4 h-24 w-auto" />
                                    <p className="mb-3 text-2xl font-bold">IT-ESEGA 2025</p>
                                    <p className="mr-70 text-base leading-relaxed">
                                        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Iure, sed mollitia at aperiam explicabo ullam odio
                                        temporibus obcaecati rerum dolorum.
                                    </p>
                                    <div className="mt-6 flex space-x-4">
                                        <a href="https://facebook.com" className="hover:text-secondary text-white transition-colors">
                                            <svg
                                        ...
                                        <a href="https://twitter.com" className="hover:text-secondary text-white transition-colors">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                width="24"
                                                height="24"
                                        ...
                                        <a href="https://instagram.com" className="hover:text-secondary text-white transition-colors">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                width="24"
                                                height="24"
                                        ...
                                        <a href="https://youtube.com" className="hover:text-secondary text-white transition-colors">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                width="24"
                                                height="24"
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-col space-y-4">
                                        <Link
                                            href={route('home')}
                                            className="hover:text-secondary group flex items-center text-white transition-colors"
                                        >
                                            Home
                                ...
                                {/* Competition */}
                                <div>
                                    <h3 className="mb-4 text-2xl font-semibold text-white">Competition</h3>
                                    <div className="flex flex-col space-y-4">
                                        <Link href="#" className="hover:text-secondary group flex items-center text-white transition-colors">
                                            Mobile Legends
                                            <span className="ml-2 transition-transform duration-300 group-hover:translate-x-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="size-5">
                                                    <path
                            ...
                            <div className="mt-8 border-t border-white/20 pt-8 text-center text-white">
