        ...
        <div className="flex flex-col lg:flex-row w-full min-h-screen">
            ...
            <Dialog open={openDialog} onOpenChange={(open) => setOpenDialog(open)}>
                <DialogContent className="p-6 max-w-md">
                    <DialogTitle className="text-lg font-semibold text-red-600">File Size Exceeded</DialogTitle>
                    <DialogDescription className="text-sm text-gray-700">
                        The file size exceeds the 2MB limit. Please choose a smaller file.
                    </DialogDescription>
                    <div className="mt-4 flex justify-end">
                        <DialogClose asChild>
                            <Button variant="outline" className="text-gray-500">Close</Button>
                        </DialogClose>
                    </div>
                </DialogContent>
            </Dialog>
