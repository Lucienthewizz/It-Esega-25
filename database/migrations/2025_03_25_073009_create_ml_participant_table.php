...
return new class extends Migration
{
    ...
    {
        Schema::create('ML_Participant', function (Blueprint $table) {
            $table->id(); 
            $table->foreignId('ml_team_id')->constrained('ML_Team')->onDelete('cascade'); // Kolom ID tim
    ...
    {
        Schema::dropIfExists('ML_Participant');
    }
};
